...
add wave -noupdate /control_unit_tb/DUT_INSTANCE/lfull
...
add wave -noupdate /control_unit_tb/DUT_INSTANCE/rfull
...
if  { [llength [find instances -bydu control_unit_svamod] ] > 0 } {
    ...
    add wave -nofilter Assertion /control_unit_tb/DUT_INSTANCE/CHECKER_MODULE/mf_*
