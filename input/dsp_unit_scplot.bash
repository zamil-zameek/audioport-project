...
let y=20
gnuplot  -geometry ${wt}x${ht}+${x}+${y} -persist  -e "set terminal x11 title \"audio0_in\"; set style line 1 lc rgb \"green\"; set style data lines; plot \"${filename}\" using 1:${li} ls 1; pause -1" &
let y=20+${dy}
gnuplot  -geometry ${wt}x${ht}+${x}+${y} -persist -e "set terminal x11 title \"audio1_in\"; set style line 1 lc rgb \"green\"; set style data lines; plot \"${filename}\" using 1:${ri} ls 1; pause -1" &
let y=20+2*${dy}
gnuplot  -geometry ${wt}x${ht}+${x}+${y} -persist -e "set terminal x11 title \"audio0_out\"; set style line 1 lc rgb \"red\"; set style data lines; plot \"${filename}\" using 1:${lo} ls 1; pause -1" &
let y=20+3*${dy}
gnuplot  -geometry ${wt}x${ht}+${x}+${y} -persist -e "set terminal x11 title \"audio1_out\"; set style line 1 lc rgb \"red\"; set style data lines; plot \"${filename}\" using 1:${ro} ls 1; pause -1" &
